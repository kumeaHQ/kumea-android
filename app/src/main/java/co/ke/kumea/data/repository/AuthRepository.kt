...
class AuthRepository @Inject constructor(
    ...
    suspend fun register(registrationToken: String, pin: String, name: String): AuthResponse {
        val res = api.register(RegisterRequest(registrationToken, pin, name = name.trim()))
