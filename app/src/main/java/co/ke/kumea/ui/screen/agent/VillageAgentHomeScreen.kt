    ...
    Card(onClick = onOpenLedger, modifier = Modifier.fillMaxWidth()) {
        Row(
            ...
            Column(horizontalAlignment = Alignment.End) {
                ...
                // Build-3 §8 felt states: "on phone" / teal ✓ "synced" —
                // "Saving…" is retired (a completed local write isn't pending).
                co.ke.kumea.ui.common.SyncBadge(pending = order.pendingSync)
            }
        }
    }
}
